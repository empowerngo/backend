...
exports.fetchDonorsList = async (ngoID) => {
  const query = `
   ...
   D.DONOR_ADDRESS, D.DONOR_CITY, D.DONOR_STATE,D.DONOR_COUNTRY, D.DONOR_PINCODE,
      D.DONOR_EMAIL, D.DONOR_MOBILE, D.DONOR_PAN, D.DONOR_TYPE,
...
exports.fetchDonorsListByNameOrMobile = async (donorFName, donorLName, donorMobile, donorPAN) => {
  const query = `
     SELECT 
      D.DONOR_ID, D.DONOR_FNAME, D.DONOR_MNAME, D.DONOR_LNAME, 
   D.DONOR_ADDRESS, D.DONOR_CITY, D.DONOR_STATE,D.DONOR_COUNTRY, D.DONOR_PINCODE,
...
exports.fetchDonorsListByParams = async (donorFName, donorLName, donorMobile, donorPAN) => {
  let query = `
    SELECT 
      D.DONOR_ID, D.DONOR_FNAME, D.DONOR_MNAME, D.DONOR_LNAME, 
      D.DONOR_ADDRESS, D.DONOR_CITY, D.DONOR_STATE, D.DONOR_COUNTRY, D.DONOR_PINCODE,
