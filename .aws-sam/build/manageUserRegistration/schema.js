...
const schema = Joi.object().keys({
  ...
  roleCode: Joi.number().valid(1, 2, 3, 4).when("reqType", { is: "s" || "u", then: Joi.required(), otherwise: Joi.optional() }),
  ...
  userID: Joi.number().when("reqType", { is: "u", then: Joi.required(), otherwise: Joi.forbidden() }),
