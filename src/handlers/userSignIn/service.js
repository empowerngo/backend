...
exports.authenticateUser = async (email, password) => {
  const query = `
   SELECT U.USER_ID, U.FNAME, U.LNAME, U.EMAIL, U.CONTACT_NUMBER, U.PASSWORD_HASH, U.ROLE_CODE, 
           N.NGO_ID, N.NGO_NAME, N.STATUS AS NGO_STATUS, N.LOGO_URL, N.SIGNATURE_URL,SEAL_URL, 
           N.AUTHORIZED_PERSON, N.NGO_80G_NUMBER, REG80G_DATE,  N.NGO_12A_NUMBER,  N.NGO_CSR_NUMBER,  N.NGO_FCRA_NUMBER,  
